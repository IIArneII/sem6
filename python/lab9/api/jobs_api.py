...
from lab9.data.tables import Job, User, Category
from datetime import datetime

blueprint = Blueprint('jobs_api', __name__, template_folder='templates')


@blueprint.get('/api/v1/jobs')
def get_jobs():
...
@blueprint.get('/api/v1/jobs/<int:job_id>')
def get_job(job_id):
    db = db_session.create_session()
...
@blueprint.delete('/api/v1/jobs/<int:job_id>')
...
@blueprint.put('/api/v1/jobs/<int:job_id>')
